  ...
  return (
    ...
    >
      ...
      <section className="MainSection pl-[10vw] lg:pl-40 h-screen snap-start justify-center flex flex-col">
          ...
          <div className="HomeLeftDiv flex flex-col text-left md:mr-10 w-[70%]">
            ...
            <div id="HomeTextDiv" className="pb-4">
              <p className="text-font-semibold text-lg w-[100%]">
                Hi, I&#39;m a 2nd Year Computer Science Student and I have built
                this website to expand my skills in front-end development.
              </p>
            </div>
            <div
              id="Icons"
        ...
        <Separator className="bg-secondary max-w-160 mb-12 mt-12 mr-40" />
      ...
      <section
        className={`infoSection pl-[10vw] lg:pl-40 bg-background min-h-screen snap-start justify-center flex flex-col`}
        style={{
            ...
            <div>
              ...
              <div className="pb-2">
                ...
                <div className="md:flex flex-wrap ml-2">
                  ...
                  <Badge variant="secondary" className="m-1 text-title">JavaScript</Badge>
                </div>
              </div>
              <div className="pb-2">
                <h3 className="m-0 text-2xl font-semibold md:text-left text-primary">
                ...
                <div className="md:flex flex-wrap ml-2">
                  ...
                  <Badge variant="secondary" className="m-1 text-title">Next.js</Badge>
                  <Badge variant="secondary" className="m-1 text-title">Pandas</Badge>
                  <Badge variant="secondary" className="m-1 text-title">Shadcn/ui</Badge>
                </div>
              </div>
            </div>
            <div className="pb-2">
