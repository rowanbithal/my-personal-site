        ...
        <div className="pb-4">
          ...
          <div className="pb-4">
            ...
            <p>
              ...
              interface, mobile compatibility, real-time availability, editable
              bookings, a check-in system to verify attendance, and personalised
              user statistics.
              <br />
          ...
          <div className="pb-4">
            ...
            <p className="pb-4">
              NoteSpace was built using React for the frontend, Spring Boot for
              the backend, and PostgreSQL for data storage. The app is fully
              containerized using Docker and version-controlled through a GitHub
              monorepo.
            </p>
            <h3 className="m-0 text-2xl font-bold text-left text-primary pb-4">
            ...
            <p className="pb-4">
              ...
              meetings in total. Each member developed a full-stack entity using
              vertical slicing, taking responsibility for both frontend and
              backend aspects. We used GitHub Projects and Kanban boards to
              plan, assign, and track tasks, ensuring collaborative and
            ...
            <p className="pb-4">
              ...
              from the dev branch to the production environment, and the app is
              publicly accessible via university-provided subdomains.
            </p>
          </div>
        </div>
      </section>
